...
namespace HindIndisk.Api.Infrastructure.Migrations
{
    ...
    [Migration("20260731140559_RemovePlacedByUserIdAndOrderReservationUserFks")]
    partial class RemovePlacedByUserIdAndOrderReservationUserFks
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HindIndisk.Api.Domain.Entities.Branch", b =>
                {
                    ...
                    b.Property<string>("AddressLine1Da")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AddressLine2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("AddressLine2Da")
                        .HasColumnType("nvarchar(max)");

                    b.Property<decimal>("BagCharge")
                        .HasColumnType("decimal(8,2)");

                    b.Property<bool>("BagChargeEnabled")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("HindIndisk.Api.Domain.Entities.BranchEmailRecipients", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("BranchEmailRecipients");
                });
            ...
            modelBuilder.Entity("HindIndisk.Api.Domain.Entities.FooterSettings", b =>
                {
                    b.Property<int>("Id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HindIndisk.Api.Domain.Entities.RegistrationOtp", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("HindIndisk.Api.Domain.Entities.AboutPageSettings", b =>
                {
                    b.HasOne("HindIndisk.Api.Domain.Entities.Branch", "Branch")
                        .WithOne("AboutPageSettings")
                        .HasForeignKey("HindIndisk.Api.Domain.Entities.AboutPageSettings", "BranchId")
            ...
            modelBuilder.Entity("HindIndisk.Api.Domain.Entities.BranchEmailRecipients", b =>
                {
                    b.HasOne("HindIndisk.Api.Domain.Entities.Branch", "Branch")
                        .WithOne("EmailRecipients")
                        .HasForeignKey("HindIndisk.Api.Domain.Entities.BranchEmailRecipients", "BranchId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("HindIndisk.Api.Domain.Entities.Branch", b =>
                {
                    b.Navigation("AboutPageSettings");

                    b.Navigation("AboutTimelineItems");
