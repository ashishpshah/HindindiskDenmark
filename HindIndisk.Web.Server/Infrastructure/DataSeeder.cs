...
public static class DataSeeder
{
    public static async Task SeedAsync(ApplicationDbContext context)
    {
        ...
        // ── Branch day schedules — reseed whenever any branch has no schedule ────
        var branchIds = await context.Branches.Select(b => b.Id).ToListAsync();
        var scheduledBranchIds = await context.BranchDaySchedules
            .Select(s => s.BranchId).Distinct().ToListAsync();
        var unseedBranchIds = branchIds.Except(scheduledBranchIds).ToList();

        if (unseedBranchIds.Count > 0)
        {
            var workdays = new[] {
                DayOfWeek.Monday, DayOfWeek.Tuesday, DayOfWeek.Wednesday,
                DayOfWeek.Thursday, DayOfWeek.Friday, DayOfWeek.Saturday,
            };
            var defaults = unseedBranchIds
                .SelectMany(bid => workdays.Select(day => new BranchDaySchedule
                {
                    BranchId               = bid,
                    DayOfWeek              = day,
            ...
            await context.BranchDaySchedules.AddRangeAsync(defaults);
            await context.SaveChangesAsync();
        }
        ...
        try
        {
            ...
            await context.BranchDaySchedules.AddRangeAsync(
                // Aarhus: Mon–Sat 12:00–22:00
                new BranchDaySchedule { BranchId = 1, DayOfWeek = DayOfWeek.Monday,    OpenTime = new TimeOnly(12, 0), CloseTime = new TimeOnly(22, 0) },
                new BranchDaySchedule { BranchId = 1, DayOfWeek = DayOfWeek.Tuesday,   OpenTime = new TimeOnly(12, 0), CloseTime = new TimeOnly(22, 0) },
                new BranchDaySchedule { BranchId = 1, DayOfWeek = DayOfWeek.Wednesday, OpenTime = new TimeOnly(12, 0), CloseTime = new TimeOnly(22, 0) },
                new BranchDaySchedule { BranchId = 1, DayOfWeek = DayOfWeek.Thursday,  OpenTime = new TimeOnly(12, 0), CloseTime = new TimeOnly(22, 0) },
                new BranchDaySchedule { BranchId = 1, DayOfWeek = DayOfWeek.Friday,    OpenTime = new TimeOnly(12, 0), CloseTime = new TimeOnly(22, 0) },
                new BranchDaySchedule { BranchId = 1, DayOfWeek = DayOfWeek.Saturday,  OpenTime = new TimeOnly(12, 0), CloseTime = new TimeOnly(22, 0) },
                // Copenhagen: Mon–Sat 11:30–23:00
                new BranchDaySchedule { BranchId = 2, DayOfWeek = DayOfWeek.Monday,    OpenTime = new TimeOnly(11, 30), CloseTime = new TimeOnly(23, 0) },
                new BranchDaySchedule { BranchId = 2, DayOfWeek = DayOfWeek.Tuesday,   OpenTime = new TimeOnly(11, 30), CloseTime = new TimeOnly(23, 0) },
                new BranchDaySchedule { BranchId = 2, DayOfWeek = DayOfWeek.Wednesday, OpenTime = new TimeOnly(11, 30), CloseTime = new TimeOnly(23, 0) },
                new BranchDaySchedule { BranchId = 2, DayOfWeek = DayOfWeek.Thursday,  OpenTime = new TimeOnly(11, 30), CloseTime = new TimeOnly(23, 0) },
                new BranchDaySchedule { BranchId = 2, DayOfWeek = DayOfWeek.Friday,    OpenTime = new TimeOnly(11, 30), CloseTime = new TimeOnly(23, 0) },
                new BranchDaySchedule { BranchId = 2, DayOfWeek = DayOfWeek.Saturday,  OpenTime = new TimeOnly(11, 30), CloseTime = new TimeOnly(23, 0) }
            );
            await context.SaveChangesAsync();
