...
public class MenuService : IMenuService
{
    ...
    public async Task<IReadOnlyList<MenuItemDto>> GetItemsAsync(
        string? category, string? q, long? branchId, bool? signature = null)
    {
        ...
        if (signature == true)
            query = query.Where(m => m.MenuItem.IsSignature);
        ...
        return rows.Select(r =>
        {
            ...
            return new MenuItemDto(r.Id, r.Name, r.NameDa, r.Description, r.DescriptionDa,
                r.ImageUrl, r.SpicyLevel, price, r.CategoryName, r.CategoryDa, r.CategoryId, labels, r.IsSignature, r.Code);
        }).ToList();
    }
    ...
    public async Task<MenuItemDetailDto> GetItemByNameAsync(string name, long? branchId)
    {
        ...
        MenuItemDto ToDto(dynamic r)
        {
            ...
            return new MenuItemDto(
                ...
                labels, (bool)r.IsSignature, (int)r.Code);
        }
