...
function MenuEditPage() {
  ...
  const handleSave = async () => {
    ...
    } catch (e) { toast.error((e as Error).message || "Failed to update menu."); }
  };
  ...
  const handleAddItem = async (itemId: number) => {
    ...
    } catch (e) { toast.error((e as Error).message || "Failed to add item."); }
  };
  ...
  const handleUnlink = async () => {
    ...
    } catch (e) { toast.error((e as Error).message || "Failed to unlink item."); }
